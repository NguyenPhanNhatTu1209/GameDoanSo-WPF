...
namespace DoAn1
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private Visibility _IsRule;
        public Visibility IsRule
        {
            get => _IsRule;
            set
            {
        ...
        private void TextBlock_MouseDown_2(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                if (DiemController.checkExistUser(TenUser.Text) == false && TenUser.Text!="")
                {
                    chedo = 0;
            ...
            else if (hard.IsChecked == true && TenUser.Text != "")
            {
                if (DiemController.checkExistUser(TenUser.Text) == false)
                {
                    chedo = 1;
                    nguoichoi.NameUser = TenUser.Text;
                    nguoichoi.Score = null;
        ...
        private void Image_MouseDown_Score(object sender, MouseButtonEventArgs e)
        {
            PlaySoundActive();
            Score diem = new Score();
            diem.Show();
            this.Close();
        }
        ...
        private void Image_MouseDown_Rule(object sender, MouseButtonEventArgs e)
        {
            IsImotal = !IsImotal;
            PlaySoundActive();
            IsRule = Visibility.Visible;
        }
